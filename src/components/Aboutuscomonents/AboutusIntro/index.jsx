            ...
            <div className="container">
                ...
                <Row gutter={[16, 16]} justify={'space-between'} align={'middle'}>
                    <Col sm={{ span: 24 }} md={{ span: 11 }} lg={{ span: 11 }}>
                        <div>
                            <Image src='assets/images/ab-intro.jpg' alt='Our Story' className='rounded-20' preview={false} />
                        </div>
                    </Col>
                        ...
                        <Flex vertical gap={20}>
                            <Flex vertical gap={5}>
                                <Title level={1} className='m-0'>
                                    <Trans i18nKey={'about_us'} components={{span: <span className='text-brown'></span> }} />
                                </Title>
                            ...
                            <div className={language === 'ar' ? 'border-r-grey px-3':'border-l-grey px-3'}>
                                <Flex vertical gap={20}>
                                    <Text className='fs-15'>
                                        <Trans i18nKey={'about_desc'} components={{span: <strong></strong>}} />
                                    </Text>
                                    <Flex>
