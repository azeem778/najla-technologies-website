            ...
            <div className="container">
                ...
                <Row gutter={[16, 16]} justify={'space-between'} align={'middle'}>
                        ...
                        <Flex vertical gap={20}>
                            <Flex vertical gap={5}>
                                <Title level={1} className='m-0'>
                                    <Trans i18nKey={'our_story'} components={{span: <span className='text-brown'></span> }} />
                                </Title>
                                ...
                                <Flex vertical gap={20}>
                                    <Flex vertical gap={10}>
                                        <Text className='fs-15'>
                                            <Trans i18nKey={'story_desc1'} components={{span: <strong></strong>}} />
                                        </Text>
                                        <Text className='fs-15'>
                                            <Trans i18nKey={'story_desc2'} components={{span: <strong></strong>}} />
                                        </Text>
                                    </Flex>
                                    <Flex>
                    ...
                    <Col sm={{ span: 24 }} md={{ span: 11 }} lg={{ span: 11 }}>
                        <Flex justify='center'>
                            {/* <Image src='assets/images/ourstory.png' alt='Our Story' className='rounded-20'  preview={false} /> */}
                            <div className='heroimginner'>
                                <img src='assets/images/ab.jpg' alt='' preview={false}/>
                            </div>
                        </Flex>
                    </Col>
                </Row>
